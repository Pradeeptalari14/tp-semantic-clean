...
> Background dedup service mapping doc_hash columns and executing auto-merge policies using Celery and pgvector.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/semantic-clean/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-semantic-clean.git
cd tp-semantic-clean
```
...
```bash
kubectl port-forward deployment/tp-semantic-clean 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── celery_task.py     # Main configuration file
```
...
---
*Generated by [SemanticClean Studio](https://pradeeptalari14.github.io/portfolio/tools/semantic-clean/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
